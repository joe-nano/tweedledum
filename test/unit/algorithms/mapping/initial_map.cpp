...
TEMPLATE_PRODUCT_TEST_CASE("Test for SAT intial map heuristic",
    "[initial_map][mapping]", (Netlist, CircuitDAG), (w3_op, wn32_op))
{
	TestType network;
...
TEMPLATE_PRODUCT_TEST_CASE("Test for random intial map heuristic",
    "[initial_map][mapping]", (Netlist, CircuitDAG), (w3_op, wn32_op))
{
	TestType network;
	initial_map_params params;
